...
public class ServicenowCreateIncident extends BaseClassServiceNow {
	...
	public void createIncident() throws InterruptedException, IOException {
		...
		driver.switchTo().frame(frame2);
		driver.findElement(By.id("incident.short_description")).sendKeys("My phone software faliure");
		driver.findElement(By.id("incident.description"))
				.sendKeys("can you check my phone within 2 days and update software");
